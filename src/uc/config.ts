...
const SPACESHIPS: {[key: string]: SpaceshipInfo} = {
    ...
    'xq2_4aha': {
        ...
        height: 4,
        width: 5,
        cells: [2, 6, 8, 10, 14, 16, 18],
        identification: [
            [4, 5, 7, [1, 3, 5, 9, 11, 13, 17], 'N'],
            [4, 5, 7, [2, 6, 8, 10, 14, 16, 18], 'S'],
            [5, 4, 7, [2, 5, 7, 8, 13, 15, 18], 'E'],
            [5, 4, 7, [1, 4, 6, 11, 12, 14, 17], 'W'],
        ],
    },
...
const CHECK_LINEAR_GROWTH = true;
