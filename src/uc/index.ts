...
import {createConfiguration, searchSalvos} from './slow_salvos.js';
...
if (cmd === 'get_ss') {
    ...
    console.log(createConfiguration({target: c.START_OBJECT.slice(c.START_OBJECT.indexOf('_') + 1), lanes})[0].toRLE());
