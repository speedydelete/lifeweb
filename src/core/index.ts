...
const GLIDER_Y = 16;
const OSC_DISTANCE = 16;
const Y_DISTANCE = 256;
const X_DISTANCE = 256;
const GLIDER = parse('x = 4, y = 6, rule = B3/S23\n2o$3bo$3bo$3bo$3bo$2o!');
const OSC_PHASES = [
    parse('x = 14, y = 14, rule = B3/S23\n6$6b2o$6b2o!'),
    parse('x = 14, y = 14, rule = B3/S23\n5$5b4o$5bo2bo$5bo2bo$5b4o!'),
    parse('x = 14, y = 14, rule = B3/S23\n3$6b2o$5bo2bo$4b2o2b2o$3bo6bo$3bo6bo$4b2o2b2o$5bo2bo$6b2o!'),
    parse('x = 14, y = 14, rule = B3/S23\n2$6b2o$4bo4bo$3bo6bo2$2bo8bo$2bo8bo2$3bo6bo$4bo4bo$6b2o!'),
    parse('x = 14, y = 14, rule = B3/S23\n2$5bo2bo$5bo2bo$4b2o2b2o$2b3o4b3o3$2b3o4b3o$4b2o2b2o$5bo2bo$5bo2bo!'),
    parse('x = 14, y = 14, rule = B3/S23\n$6b2o$3b2o4b2o$2bo8bo$2bo8bo2$bo10bo$bo10bo2$2bo8bo$2bo8bo$3b2o4b2o$6b2o!'),
    parse('x = 14, y = 14, rule = B3/S23\n5bo2bo$4b2o2b2o$2bob2o2b2obo$3bobo2bobo$b2obo4bob2o$4o6b4o3$4o6b4o$b2obo4bob2o$3bobo2bobo$2bob2o2b2obo$4b2o2b2o$5bo2bo!'),
    parse('x = 14, y = 14, rule = B3/S23\n5bo2bo$2bo8bo$bo10bo3$o4bo2bo4bo3$o4bo2bo4bo3$bo10bo$2bo8bo$5bo2bo!'),,
] as Pattern[];
...
for (let lane = 0; lane < 13; lane++) {
    let x = 0;
    let y = lane * Y_DISTANCE;
    for (let oscPhase = 0; oscPhase < 8; oscPhase++) {
        for (let xDist = 0; xDist < 4; xDist++) {
            let p = base.copy();
            p.ensure(64, 64);
            p.insert(GLIDER, 0, GLIDER_Y);
            p.insert(OSC_PHASES[oscPhase], OSC_DISTANCE + xDist, lane);
            out.ensure(x + p.width, y + p.height);
            out.insert(p, x, y);
            x += X_DISTANCE;
        }
    }
...
out.rule.str = 'R2,C2,S4,B4';
console.log(out.toRLE());
