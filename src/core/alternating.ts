...
export class AlternatingPattern extends DataPattern {
    ...
    clearedCopy(): this {
        return new AlternatingPattern(0, 0, new Uint8Array(0), this.rule, this.patterns) as this;
    }
    ...
    copyPart(x: number, y: number, height: number, width: number): this {
        ...
        return new AlternatingPattern(height, width, data, this.rule, this.patterns) as this;
    }
