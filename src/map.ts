...
/* 
version from life.ts adapted for arbitrary MAP rules
B1c introduces a special case, so it is handled seperately
*/

export function runMAP(p: Pattern, trs?: Uint8Array): void {
    if (!trs) {
